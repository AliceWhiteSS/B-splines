function RHS = compute_Integ_Domainb_fid(Jm,Bterm1f,Bterm2f,Bterm3f,RHSf,PHI1,par2,w1,w2,w3,H)
    ...
    for gg1 = 1:xlen,
        for gg2 = 1:xlen,
            for gg3 = 1:xlen
                ...
                valm1f(:,gg1,gg2,gg3) = par2*(phi_i)*(term1f(gg1,gg2,gg3));
                valm2f(:,gg1,gg2,gg3) = par2*(phi_i)*(term2f(gg1,gg2,gg3));
                valm3f(:,gg1,gg2,gg3) = par2*(phi_i)*(term3f(gg1,gg2,gg3));
