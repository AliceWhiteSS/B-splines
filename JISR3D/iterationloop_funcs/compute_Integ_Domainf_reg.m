function RHS = compute_Integ_Domainf_reg(Jm,BIGX, BIGY, BIGZ,FBX, FBY,FBZ, FBXDX,FBXDY,FBXDZ, FBYDX, FBYDY, FBYDZ, FBZDX, FBZDY,FBZDZ, BFX, BFY, BFZ,BIGMUXf,BIGMUYf,BIGMUZf,BIGMVXf,BIGMVYf,BIGMVZf,BIGMWXf,BIGMWYf,BIGMWZf,RHSf,PHI1, PHIU1, PHIV1, PHIW1, PHIF1,lambda_1,lambda_3,mu,w1,w2,w3,H)
    ...
    for gg1 = 1:xlen,
        for gg2 = 1:xlen,
            for gg3 = 1:xlen
                ...
                valm1f(:,gg1,gg2,gg3) = 2*lambda_1*(term4f(gg1,gg2,gg3).*phi_ui+term5f(gg1,gg2,gg3).*phi_vi+term6f(gg1,gg2,gg3).*phi_wi) + lambda_3.*reg1fb;
                valm2f(:,gg1,gg2,gg3) = 2*lambda_1*(term7f(gg1,gg2,gg3).*phi_ui+term8f(gg1,gg2,gg3).*phi_vi+term9f(gg1,gg2,gg3).*phi_wi) + lambda_3.*reg2fb;
                valm3f(:,gg1,gg2,gg3) = 2*lambda_1*(term10f(gg1,gg2,gg3).*phi_ui+term11f(gg1,gg2,gg3).*phi_vi+term12f(gg1,gg2,gg3).*phi_wi)+ lambda_3.*reg3fb;
