function [Basis,Elem] = setBsplineGrid_func_withoutNode(knotvectorU, knotvectorV, knotvectorW,param,maxlevel)
...
for level = 1:maxlevel
    ...
    %store element array
    [knot_ind, chdElem, Parcell, IEN, cell_centre, supp_i] = storeElemArray(level,param,knot_cu, knot_cv, knot_cw,maxlevel);
